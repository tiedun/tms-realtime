...
INSERT INTO `tms_config_dim`(`source_table`, `sink_table`, `sink_columns`, `primary_key`, `sink_extend`) values('base_dic', 'dim_base_dic', 'id,name', 'id', '');
...
INSERT INTO `tms_config_dim`(`source_table`, `sink_table`, `sink_columns`, `primary_key`, `sink_extend`) values('express_courier_complex', 'dim_express_courier_complex', 'id,courier_emp_id,complex_id,create_time,update_time,is_deleted', 'id', '');
