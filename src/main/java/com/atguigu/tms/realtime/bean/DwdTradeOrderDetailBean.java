...
public class DwdTradeOrderDetailBean {
    ...
    public void mergeBean(DwdOrderDetailOriginBean detailOriginBean, DwdOrderInfoOriginBean infoOriginBean) {
        ...
        this.weight = new BigDecimal(detailOriginBean.weight);
        this.orderTime = detailOriginBean.createTime;
        this.ts = DateFormatUtil.toTs(detailOriginBean.createTime, true);
        ...
        this.amount = new BigDecimal(infoOriginBean.amount);
        this.estimateArriveTime = infoOriginBean.estimateArriveTime;
        this.distance = new BigDecimal(infoOriginBean.distance);
    }
}
